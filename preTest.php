    ...
    <div class="container">
        <div class="media-container-row">
            <div class="mbr-text col-12 col-md-8 mbr-fonts-style display-2">
                <blockquote><strong>الإختبار الأولي</strong><span style="font-style: normal;"> يساعدنا على تقييم مستوى معرفتك بمجال الدورة ومقارنتها بالاختبار النهائي في نهاية المسار</span></blockquote>
            </div>
        </div>
    </div>
</section>
...
if($preTest==null||$preTest=="" ) {echo'<h3>لايوجد اختبار <h3>';} 
else {echo '<iframe src="'.$preTest.'"  width="1300px" height="3500px" frameborder="0" marginheight="0" marginwidth="0">Loading...</iframe>';
 echo '<form action="preupdate.php?eventID='.$eventID.'" method="POST"><span class="input-group-btn"> <button type="submit" style="color:red;" class="btn btn-primary btn-form display-4">أقر بأني اتممت الإختبار</button> </span>
</form>';
}?>
