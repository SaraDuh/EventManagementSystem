...
<head>
  ...
  <title>حساب  <?php  echo $aName; ?></title>
    ...
    <nav class="navbar navbar-expand beta-menu navbar-dropdown align-items-center navbar-fixed-top navbar-toggleable-sm">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav nav-dropdown" data-app-modern-menu="true"><li class="nav-item">
                ...
                </li><li class="nav-item"><a class="nav-link link text-white display-4" href=""><span class="mbri-login mbr-iconfont mbr-iconfont-btn"></span>&nbsp;تسجيل الدخول&nbsp;</a></li></ul>
                 ...
                 <center><table>
                      ...
                      <tr>
                       ...
                       <td><p class="mbr-text mbr-fonts-style display-7">: تاريخ انتهاء البطاقة </p></td>
							 ...
							 <?php echo' <center>      <span class="input-group-btn">
									<a class="btn btn-md btn-primary display-4" href="EditAttProfile.php?attEmail='.$attEmail.'">تعديل البيانات</a>
                        </span> </center>'; ?>
