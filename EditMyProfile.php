...
if ( !(empty($_POST['mobile']) && empty($_POST['gender']) && empty($_POST['specialization']) && empty($_POST['city'])&& empty($_POST['nationality']) && empty($_POST['password'])&& empty($_POST['abuse'])&& empty($_POST['type']) ) )
{
...
$sql = "UPDATE attendant SET  mobile='$mobile', gender='$gender', specialization='$specialization', position='$position', employer='$employer', department='$department', city='$city', nationality='$nationality', workTel='$workTel', workTrans='$workTrans', fax='$fax', faxTran='$faxTran', cardID='$cardID', cardDate='$cardDate', password='$password', abuse='$abuse', type='$type' WHERE attEmail='$attEmail'";


if (mysqli_query($con,$sql)) {header('Location:myprofile.php?updated=true'); } 
else{header('Location:myprofile.php?invalidUD=true'); }
    ...
    <div class="container">
        <div class="row justify-content-center" style="background-color: white;">
            <div class="media-container-column col-lg-8" >
                    <form class="mbr-form" action="EditMyProfile.php" method="post" dir="rtl" style="text-align:right;" >
                        ...
                        <div class="row row-sm-offset">
                            <div class="col-md-4 multi-horizontal" data-for="Aname">
                                <div class="form-group">
                                   <label class="form-control-label mbr-fonts-style "> الاسم الثلاثي بالعربي:<br> <?php echo $aName; ?></label>
                                </div>
                            </div>
                              <div class="col-md-4 multi-horizontal" data-for="Ename">
                                <div class="form-group">
                                   <label class="form-control-label mbr-fonts-style ">الاسم الثلاثي بالانجليزي: <br><?php echo $eName; ?></label>
                                </div>
                            </div>
                        </div>
						<div class="row row-sm-offset">
	             ...
	             <div id="jobinfo2"></div>
                    ...
                    <div id="cardinfo2"> </div>
						...
						<div class="row row-sm-offset">
							 ...
							 <div class="col-md-4 multi-horizontal" >
                                <div class="form-group">
                                   <label class="form-control-label mbr-fonts-style ">البريد الألكتروني: <br><?php echo $attEmail; ?></label>
                                </div>
                            </div>
							<div class="col-md-4 multi-horizontal" >
                                <div class="form-group">
